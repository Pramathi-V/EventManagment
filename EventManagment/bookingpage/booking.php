...
<body id="home" style = "Background: #e2daf1;">
    <header class="homepage" >
        <nav id="navbar">
            ...
            <div class="homepage-content" >
                ...
                <?php
                      $vId = isset($_GET['id']) ? $_GET['id'] : null;

                      if ($vId) {
                        $vsql = "SELECT name FROM venue WHERE id = $vId";
                        $vnameResult = mysqli_query($data, $vsql);
                        $venue = mysqli_fetch_assoc($vnameResult);
                        if ($venue) {
                        ...
                        // Free the result set
                        mysqli_free_result($vnameResult);
                    }
                    ?>
                <form action="" class="booking" method="post">
                    ...
                    <div class="booking-form">
                     ...
                     <input type="number" name="size" id="size" placeholder="Enter no of audience" required min="1">
                      </div>
                            </br>
                    <div class="booking-form">
