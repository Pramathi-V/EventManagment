                ...
                <table class="table table-striped table-hover">
                      ...
                      <?php
                       ...
                       while($row = mysqli_fetch_array($res)){
                        ...
                        $venueId = $row["id"];
                        $bookingCountQuery = "SELECT COUNT(id) AS booking_count FROM venue_booking WHERE venue_id = $venueId;";
                        $bookingCountResult = mysqli_query($data, $bookingCountQuery);
                        $bookingCountRow = mysqli_fetch_array($bookingCountResult);
                        $bookingCount = $bookingCountRow["booking_count"];
    
                        echo "<td>"; echo $bookingCount; echo "</td>";
                        $id =  $row["id"];
